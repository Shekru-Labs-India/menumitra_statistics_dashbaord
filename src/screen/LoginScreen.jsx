        ...
        <div className="layout-page">
          <div className="content-wrapper">
            ...
            <div className="container-xxl flex-grow-1 container-p-y">
              ...
              <div className="illustrations-container" style={{ position: 'fixed', bottom: 0, left: 0, right: 0, pointerEvents: 'none' }}>
                <img src={tree3} alt="auth-tree" className="authentication-image-object-left d-none d-lg-block" style={{ position: 'absolute', bottom: '0', left: '0' }} />
                <img src={authMaskLight} className="authentication-image d-none d-lg-block scaleX-n1-rtl" height="172" alt="triangle-bg" data-app-light-img="illustrations/auth-basic-mask-light.png" data-app-dark-img="illustrations/auth-basic-mask-dark.png" style={{ position: 'absolute', bottom: '0', left: '50%', transform: 'translateX(-50%)' }} />
                <img src={tree} alt="auth-tree" className="authentication-image-object-right d-none d-lg-block" style={{ position: 'absolute', bottom: '0', right: '0' }} />
              </div>
            </div>
            {/* / Content */}
          </div>
